...
REM download of best video and audio - will usually be webm
...
REM OLD "%youtube_dl_exe%" --no-call-home --console-title --verbose --ignore-config --prefer-ffmpeg --ffmpeg-location "%ffmpeg_location%" --buffer-size 64k --no-mtime --console-title --force-ipv4 --no-mark-watched --ignore-errors --restrict-filenames --format "337/336/335/334/315/313/271/264/303/299/248/137/302/298/247/136/22/(bestvideo+bestaudio/best)" %theURL%
REM OLD "%youtube_dl_exe%" --no-call-home --console-title --verbose --ignore-config --prefer-ffmpeg --ffmpeg-location "%ffmpeg_location%" --buffer-size 64k --no-mtime --console-title --force-ipv4 --no-mark-watched --ignore-errors --restrict-filenames --format "bestvideo[ext=webm]+bestaudio[ext=webm]/best[ext=webm]" %theURL%

REM download of best mpeg4 video and m4a audio - will usually be mp4
REM "%youtube_dl_exe%" --no-call-home --console-title --verbose --ignore-config --prefer-ffmpeg --ffmpeg-location "%ffmpeg_location%" --buffer-size 64k --no-mtime --console-title --force-ipv4 --no-mark-watched --ignore-errors --restrict-filenames --format "bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]" %theURL%
REM "%youtube_dl_exe%" --no-call-home --console-title --ignore-config --prefer-ffmpeg --ffmpeg-location "%ffmpeg_location%" --buffer-size 64k --no-mtime --console-title --force-ipv4 --no-mark-watched --ignore-errors --restrict-filenames --format "bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]" %theURL%

REM download the BEST regardless of file extension
"%youtube_dl_exe%" --no-call-home --console-title --ignore-config --prefer-ffmpeg --ffmpeg-location "%ffmpeg_location%" --buffer-size 64k --no-mtime --console-title --force-ipv4 --no-mark-watched --ignore-errors --restrict-filenames --format "bestvideo+bestaudio" %theURL%
