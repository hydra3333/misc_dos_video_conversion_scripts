...
"%youtube_dl_exe%" --ignore-config --help > .\youtube-dl.help.fullhelp.txt 2>&1
"%youtube_dl_exe%" --ignore-config --extractor-descriptions > .\youtube-dl.help.extractor-descriptions.txt 2>&1
